...
ifeq ($(findstring Release,$(MAKECMDGOALS)),Release)
	...
	TARGET_LIBS =  $(shell pkg-config  jack glew gstreamer-0.10 gstreamer-video-0.10 gstreamer-base-0.10 gstreamer-app-0.10 libudev cairo --libs) $(OF_ROOT)/libs/openFrameworksCompiled/lib/$(LIBSPATH)/libopenFrameworks.a
	TARGET_NAME = Release
endif
